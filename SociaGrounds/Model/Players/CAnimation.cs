...
namespace SociaGrounds.Model.Players
{
    public class CAnimation
    {
        ...
        /// Constructor
        /// </summary>
        /// <param name="spriteSheat">The spritesheet to be parsed</param>
        ...
        public CAnimation(Texture2D spriteSheat, Vector2 position, int frameWidth, int frameHeight, int startRow, int fps, bool isLooping)
        {
            ...
            var textureData = new Color[spriteSheat.Width * spriteSheat.Height];
            spriteSheat.GetData(textureData);
        }
        ...
        {
            spriteBatch.Draw(_spriteSheat, Position, _sourceRect, Color.White);
        }
    }
}
